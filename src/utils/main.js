...
window.addEventListener('load', () => {
    ...
    $('#image_file').change(function () {
        ...
        let file = $('#image_file')[0].files[0].name;
    ...
    $(() => {
        ...
        function handleCreatePost(e) {
            ...
            let description = document.forms['formCreate'].elements['description'].value
            let video = document.forms['formCreate'].elements['video'].value
